...
public class RazorpayPlugin implements FlutterPlugin, MethodCallHandler,
                                       ActivityAware,
  ...
  onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    eventChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(),
                                    "razorpay_flutter_customui_with_turbo_upi");
  ...
  public void onMethodCall(@NonNull MethodCall call,
    ...
    case "submit":
      razorpayDelegate.submit(
          new JSONObject((Map<String, JSONObject>)call.arguments), result);
      break;
    ...
    case "getBankLogoUrl":
      result.success(
          razorpayDelegate.getBankLogoUrl(call.arguments.toString()));
      break;

    case "getCardNetwork":
      result.success(
          razorpayDelegate.getCardNetwork(call.arguments.toString()));
      break;

    case "getCardNetworkLength":
      result.success(String.valueOf(
          razorpayDelegate.getCardNetworkLength(call.arguments.toString())));
      break;
    ...
    case "getLinkedUpiAccounts":
      razorpayDelegate.getLinkedUpiAccounts(call.arguments.toString(), result,
                                            this.eventSink);
      break;
    case "getBalance":
    ...
    case "selectedBankAccount":
      ...
      razorpayDelegate.selectedBankAccount(bankAccountStr, result,
                                           this.eventSink);
      break;
    case "setUpUPIPin":
    ...
    case "linkNewUpiAccountTPV":
      ...
      razorpayDelegate.linkNewUpiAccount(customerMobile, customerId, orderId,
                                         tpvBankAccount, result,
                                         this.eventSink);
      break;
    ...
    case "linkNewUpiAccountWithUI":
      ...
      razorpayDelegate.linkNewUpiAccountWithUI(customerMobile, color, result,
                                               this.eventSink);
      break;

    case "manageUpiAccounts":
      customerMobile = call.arguments.toString();
      razorpayDelegate.manageUpiAccounts(customerMobile, result,
                                         this.eventSink);
      break;
  ...
  // Commented out as Registrar is removed from flutter 2.0
  // @RequiresApi(api = Build.VERSION_CODES.KITKAT)
  ...
  onAttachedToActivity(ActivityPluginBinding activityPluginBinding) {
    ...
    this.razorpayDelegate =
        new RazorpayDelegate(activityPluginBinding.getActivity());
    ...
    permissionResultListener =
        new PluginRegistry.RequestPermissionsResultListener() {
          ...
          public boolean onRequestPermissionsResult(
            ...
            razorpayDelegate.handlePermissionResult(requestCode, permissions,
                                                    grantResults);
            return false;
          }
        };
